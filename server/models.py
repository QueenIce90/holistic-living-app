...
class Chat(db.Model, SerializerMixin):
    ...
    healthconditions = db.relationship('HealthCondition', secondary = 'chat_healthconditions_association', back_populates = 'chats')
...
class Treatment(db.Model, SerializerMixin):
    ...
    healthcondition = db.relationship('HealthConditions', secondary = 'healthcondition_treatment_association', back_populates = 'treatment')
